...
public class LeaveDetails {
  ...
  public final String toString() {
    return "leaveEmpId:" + leaveEmpId + " leaveId: " + leaveId + " leaveType:" + leaveType
           + "leaveStartDate:" + leaveStartDate + "leaveEndDate:" + leaveEndDate + leaveAppliedOn
           + leaveAppliedOn + " leaveReason: " + leaveReason + " leaveNumOfDays: " + leaveNumOfDays
 ...
 */
  public static String approveDeny(final int argLeaveId,
      ...
      final String argLeaveMgrComments) {
    String res = "";
    LeaveDetails ld = dao().listById1(argLeaveId);
 ...
 */
  public static String applyLeave(final String argLeaveStartDate,
    ...
    int empManagerId = e.getEmpManagerId();
    days = days + 1;
    ...
    } else if (empManagerId == 0) {
      LeaveStatus leaveStatus = LeaveStatus.APPROVED;
      String strleaveAppliedOn = sdf.format(cur);
      dao().insert(argLeaveStartDate, argLeaveEndDate,
                   argLeaveNumOfDays, strleaveAppliedOn, argLeaveReason, argEmpId, leaveStatus, argLeaveType);
      edao().decrement(argEmpId, dif);
